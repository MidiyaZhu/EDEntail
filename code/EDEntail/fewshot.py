            ...
            for order in orders:
                for hypothesis in hy:
                    ...
                    for repeatnum in range(5):
                        train_file =f'./{dataname.lower()}_{str(num)}_{order}_{hypothesis}_trainnli_{repeatnum}.csv'
                        dev_file = f'./{dataname.lower()}_{str(num)}_{order}_{hypothesis}_devnli_{repeatnum}.csv'
                        test_file = './' + dataname.upper() + '/' + dataname.lower()+'_test.csv'

                        testsyns_file = f'./{dataname.lower()}_{str(num)}_{order}_{hypothesis}_testnli.csv'
