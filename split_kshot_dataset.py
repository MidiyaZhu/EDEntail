...
def mainaman(k):
    dataname='aman'
    for n in range(5):
        trainfile='.32-shot-dataset/'+str(k)+'/' + dataname.upper() + '/' + dataname.lower() +'select_train_'+str(n)+'.csv'
        selectfile='32-shot-dataset/er/' + dataname.upper() + '/' + dataname.lower() +'.csv'
        trainsample = []
        ...
        '''dev'''
        devfile = '32-shot-dataset/er/'+str(k)+'/' +dataname.upper() + '/' + dataname.lower() + 'select_dev_' + str(n) + '.csv'
        ...
        testfile = '32-shot-dataset/er/'+str(k)+'/' + dataname.upper() + '/' + dataname.lower() + 'select_test02_'+str(n)+'.csv'
